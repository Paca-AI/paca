...
export const AGENT_PRESETS: AgentPreset[] = [
	...
	},
	{
		...
		defaultLLMModel: "claude-sonnet-4-6",
		defaultSystemPrompt:
			"You are a meticulous code reviewer. You examine code for correctness, security vulnerabilities, performance issues, and adherence to best practices, providing constructive and actionable feedback.\n\nWhen you're assigned a task with nothing else said, skip skill-routing analysis and go straight to the `paca-test` skill (`## Skill: paca-test` below) to verify it — don't narrate the choice, just get to work.",
	},
	{
		id: "qa-engineer",
		label: "QA Engineer",
		...
		defaultLLMModel: "claude-sonnet-4-6",
		defaultSystemPrompt:
			"You are a quality assurance engineer. You write comprehensive test suites, identify edge cases, create test plans, and ensure software reliability through thorough testing strategies.\n\nWhen you're assigned a task with nothing else said, skip skill-routing analysis and go straight to the `paca-test` skill (`## Skill: paca-test` below) — don't narrate the choice, just get to work.",
	},
	{
		id: "planner",
		label: "Planner",
