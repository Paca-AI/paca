...
export function AddTaskRow({
	...
	const resolvedLabel = label ?? t("project.interactions.addTask.addTask");
	const resolvedPlaceholder =
		placeholder ?? t("project.interactions.addTask.titlePlaceholder");
	...
	const actionButtons = (
		<>
			...
			>
				{t("project.interactions.addTask.cancel")}
			</button>
			<button
				type="button"
				onClick={submit}
			...
			>
				{t("project.interactions.addTask.create")}
			</button>
		</>
	);
