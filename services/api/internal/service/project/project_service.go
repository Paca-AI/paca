	...
	defaultRoles := []*projectdom.ProjectRole{
		...
		},
		{
			...
			Permissions: map[string]any{
				...
				string(authz.PermissionProjectSettingsTaskTypesRead):     true,
				string(authz.PermissionProjectSettingsTaskTypesWrite):    true,
				string(authz.PermissionProjectSettingsTaskStatusesRead):  true,
				string(authz.PermissionProjectSettingsTaskStatusesWrite): true,
				string(authz.PermissionProjectSettingsCustomFieldsRead):  true,
				string(authz.PermissionProjectSettingsCustomFieldsWrite): true,
