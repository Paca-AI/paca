...
2. Resolve the LLM provider to Goose's own env var shape (`GOOSE_PROVIDER`, `GOOSE_MODEL`, and a provider-specific API key env var — see `resolveProviderEnv`).
